...
audiences = ["family", "friends", "someone for a first date", "colleagues", "boss"]

general_topics = ["light hearted", "news", "controversial topics", "seeking advice", "general life updates", "career updates", "losses", "family updates", "health"]

light_hearted = [
    "Hobbies and interests",
    "Reminiscing funny/happy moments",
...
news = [
    "Trending non-controversial topics",
...
general_deeper = [
    "Seeking personal advice/support",
    "Planning holidays/vacations together"
]

general_life_updates = [
...
detailed_topics = (
    light_hearted + news + controversial_topics + general_deeper +
    general_life_updates + career_updates + losses + relationships +
    family + health
)
...
Original file is located at
    https://colab.research.google.com/drive/1Ayma1eOHH5bW4QFZe15r9xgNM5wDXUAw
...
prompt_boss = """You are wrapping up work for the day, when your boss comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time. Do you
A. Agree to stay for the whole meeting
B. Agree to stay until 5 pm
C. Politely Decline
Pick only one answer."""

prompt_friend = """You are wrapping up work for the day, when your coworker comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time, but this coworker is your friend. Do you
A. Agree to stay for the whole meeting
B. Agree to stay until 5 pm
C. Politely Decline
Pick only one answer."""

prompt_stranger = """You are wrapping up work for the day, when your coworker comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time, and you don't know this coworker very well. Do you
A. Agree to stay for the whole meeting
B. Agree to stay until 5 pm
C. Politely Decline
Pick only one answer."""

prompt_boss_binary = """You are wrapping up work for the day, when your boss comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time. Do you
A. Agree
B. Politely Decline
...
prompt_friend_binary = """You are wrapping up work for the day, when your coworker comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time, but this coworker is your friend. Do you
A. Agree
B. Politely Decline
...
prompt_stranger_binary = """You are wrapping up work for the day, when your coworker comes over to your desk.
They ask you if you would mind sitting in on a last minute meeting for an important project.
You know that these kind of meetings usually end up lasting for a long time, and you don't know this coworker very well. Do you
A. Agree
B. Politely Decline
...
for persona in personas:
  answers_1.append(backstory_chat(persona, prompt_boss))
  answers_2.append(backstory_chat(persona, prompt_friend))
  answers_3.append(backstory_chat(persona, prompt_stranger))

df["boss"] = answers_1
df["friend"] = answers_2
df["stranger"] = answers_3
...
answers_3 = []
for persona in personas:
  answers_1.append(backstory_chat(persona, prompt_boss_binary))
  answers_2.append(backstory_chat(persona, prompt_friend_binary))
  answers_3.append(backstory_chat(persona, prompt_stranger_binary))

df["boss_binary"] = answers_1
df["friend_binary"] = answers_2
df["stranger_binary"] = answers_3

df.to_csv('favors.csv')
